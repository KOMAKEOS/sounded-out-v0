      ...
      {ticketUrl && (
        ...
        >
          {event.sold_out ? (
            ...
            <>Get Tickets · {formatPrice(event.price_min, event.price_max)}</>
          )}
        </a>
      )}
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            gap: '6px',
            padding: '16px 12px',
            background: isSaved ? 'rgba(248,113,113,0.15)' : 'rgba(255,255,255,0.05)',
            border: isSaved ? '1px solid rgba(248,113,113,0.3)' : '1px solid rgba(255,255,255,0.1)',
            borderRadius: '12px',
            cursor: 'pointer',
            minHeight: '72px',
          }}
        ...
        {mapsUrl && (
          ...
          >
            ...
            <span style={{ fontSize: '12px', fontWeight: 600, color: '#999' }}>
              Directions
            </span>
          </a>
        )}

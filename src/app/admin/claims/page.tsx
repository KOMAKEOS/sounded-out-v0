  ...
  if (!passcodeEntered) {
    return (
      <div style={{
        ...
        <Link href="/admin" style={{ color: '#666', fontSize: '13px', marginTop: '24px', textDecoration: 'none' }}>
          ← Back to admin
        </Link>
      </div>
    )
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Link href="/admin" style={{ color: '#888', textDecoration: 'none', fontSize: '14px' }}>
            ← Back
          </Link>
          <span style={{ 
            padding: '4px 10px', 

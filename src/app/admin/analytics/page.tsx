...
// Additional function exports that your event page needs
export const trackEventSave = trackSaveEvent // Alias for existing function
export const trackEventUnsave = (eventId: string, eventTitle: string, venueName?: string): void => {
  trackSaveEvent(eventId, eventTitle, 'unsave', venueName)
}
export const trackEventShare = trackShareClick // Alias for existing function
export const trackClaimStarted = trackClaimStart // Alias for existing function

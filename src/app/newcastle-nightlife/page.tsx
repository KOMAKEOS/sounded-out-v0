...
export default function NewcastleNightlifePage() {
  ...
  return (
    <div style={{
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1000px' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '12px', fontWeight: 600, color: 'rgba(255,255,255,0.7)', letterSpacing: '1px', textTransform: 'uppercase' }}>
              Live • {getDayName()} {new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'long' })}
            </span>
          </div>
      ...
      <section style={{
        padding: '120px 24px',
        background: 'linear-gradient(180deg, #050505 0%, #0a0812 100%)',
      }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <p style={{ marginBottom: '24px' }}>
              <strong style={{ color: 'white' }}>Sounded Out is Newcastle&apos;s live nightlife map.</strong> We show what&apos;s actually happening tonight — clubs, DJ events, live music, and late-night venues — all in one place, updated daily.
            </p>
            <p style={{ marginBottom: '24px' }}>
              No more scrolling through Instagram stories. No more asking &quot;what&apos;s on?&quot; in group chats. No more outdated listings. Just clarity on every event in Newcastle, with prices, times, and honest recommendations.
            </p>
            <p style={{ marginBottom: '24px' }}>
              <strong style={{ color: 'white' }}>SO Picks</strong> are events we think stand out — for the music, the atmosphere, or the community. Not paid placements. Just events we genuinely think are worth your time.
            </p>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.2)' }}>
            © {new Date().getFullYear()} Sounded Out. All rights reserved.
          </p>
        </div>
      </footer>
